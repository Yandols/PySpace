...
class Away:
            ...
            for mention in tmp:
                if mention.mention in data:
                    if data[mention.mention]['MESSAGE'] is True:
                        ...
                        msg = '{} is currently away and {}'.format(mention.name, data[mention.mention]['MESSAGE'])
    ...
    async def _away(self, context, *message: str):
        ...
        if author_mention in data:
            ...
            msg = '{} is now back.'.format(context.message.author.name)
        else:
            ...
            msg = '{} is now set as away.'.format(context.message.author.name)
